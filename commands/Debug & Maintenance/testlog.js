...
module.exports.run = async (client, message, args, settings) => { 
    try {
        message.reply(`:gear: Message envoyé dans le salon des logs`)
        const logchannel = settings.logChannel;
        logchannel.send(`:ok: Voici le message envoyé dans le salon des logs `)
...
module.exports.help = MESSAGES.COMMANDS.ADMIN.TESTLOG;