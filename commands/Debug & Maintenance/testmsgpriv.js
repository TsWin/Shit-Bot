...
module.exports.run = (client, message, args) => {    
    try {
            message.channel.send(':incoming_envelope: Un message vous à été envoyé en privé')
            message.author.send(':white_check_mark: Ceci est un message privé de test')
    } catch (error) {
...
module.exports.help = MESSAGES.COMMANDS.ADMIN.TESTMSGEMBED;